...
def det_process(opts, frame_recv, det_res_send, w_img, h_img, config, client_state):
    ...
    try:
        ...
        action_count = [[0 for prop in prop_choices] for det_scale in det_scales_choices]
        ...
        while 1:
            ...
            if k > 0 and k % rl_stride == 0:
                result, metrics = model.detect(img, get_metrics=True, get_switch_metric=False, get_area_metric=False)
                ...
                action_count[actions[1]][actions[0]] +=1
