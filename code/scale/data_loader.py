...
class CustomCocoResult:
    ...
    def add_mmdet_results(self, im_info, result, add_to_res_dict=None):
        ...
        for i in range(len(result)):
            ...
            for det in result[i]:
                ...
                if add_to_res_dict is not None:
                    res_dict.update(add_to_res_dict)
    ...
    def _parse_result_list(self, result_output):
    ...
    def evaluate(self, save_as=None, cat_ids=None):
        ...
        with StdOutCapturing() as result_output:
            ...
            coco_eval.summarize()
        results = self._parse_result_list(result_output)
