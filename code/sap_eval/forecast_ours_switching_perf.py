...
def parse_args():
    ...
    parser.add_argument('--rl-model-epoch', type=int, required=True)
...
def det_process(opts, frame_recv, det_res_send, w_img, h_img, config, client_state):
    ...
    try:
        ...
        rl_model.load(opts.rl_model_folder, "epoch_{}".format(opts.rl_model_epoch))
        ...
        while 1:
            ...
            if k > 0 and k % rl_stride == 0:
                ...
                print(k, fidx, curr_model, prop_choices[actions[0]], det_scales_choices[actions[1]])
            else:
